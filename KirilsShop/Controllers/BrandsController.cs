...
namespace KirilsShop.Controllers
{
    public class BrandsController : Controller
    {
        ...
        {
              return _context.CarBrands != null ? 
                          View(await _context.CarBrands.ToListAsync()) :
                          Problem("Entity set 'AppDbContext.CarBrands'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppDbContext.CarBrands'  is null.");
            }
            var brand = await _context.CarBrands.FindAsync(id);
            if (brand != null)
            {
        ...
        {
          return (_context.CarBrands?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
